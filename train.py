...
def train(args, embedding, Data, log_dir, logger, writer=None):
    ...
    for epoch in range(1, args.epochs+1):
        ...
        for mode in args.modes:
            ...
            #sampled_features: 5953*300, sampled_adj: 400*5953 prior: 200*2 nodes: 400 sampled_labels: 200*600
        ...
        if epoch % args.save_every == 0:
            ...
            train_acc, test_acc, std = evaluate(args, learned_embed, logger)#Evaluate
            duration = time.time() - t
...
if __name__ == '__main__':
    ...
    args.superv_ratio = float(args.superv_ratio)#用于训练的数据占比(80%)
    ...
    args.feature_len = Data.feature_len#dim 300
    args.content_len = Data.content_len#dim 300
    #23417 564290 293
